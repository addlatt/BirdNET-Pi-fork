#!/usr/bin/env bash
# DEPRECATED: This script is superseded by internal/recording/custom.go in the Go rewrite.
# It is kept for reference only. Use the Go implementation for new deployments.
set -x
