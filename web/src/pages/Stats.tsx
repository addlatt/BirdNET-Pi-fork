...
import type { StatsResponse, Species, ListSpeciesParams } from '../types/api';
...
const SORT_OPTIONS: SortOption[] = [
  { value: 'occurrences', label: 'Occurrences', icon: '↓#' },
  { value: 'alphabetical', label: 'A-Z', icon: 'Az' },
  { value: 'confidence', label: 'Confidence', icon: '↓%' },
  { value: 'date', label: 'Recent', icon: '📅' },
];
