          ...
          <tr>
            ...
            <div class="centered_image_container" style="margin-bottom: 0px !important;">
              ...
              <form action="" method="GET">
                  ...
                  <img style="width: unset !important; display: inline; height: 1em; cursor: pointer;" title="Info" src="/assets/images/info.png" width="25"></a>
                  <a href="https://wikipedia.org/wiki/<?php echo $sciname;?>" target="_blank"><img style="width: unset !important; display: inline; height: 1em; cursor: pointer;" title="Wikipedia" src="/assets/images/wiki.png" width="25"></a>
                  <img style="width: unset !important;display: inline;height: 1em;cursor:pointer" title="View species stats" onclick="generateMiniGraph(this, '<?php echo $comnamegraph; ?>')" width=25 src="/assets/images/chart.svg">
