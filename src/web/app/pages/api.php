<?php
/**
 * API endpoint for BirdNET-Pi
 * Expects to be included via the front controller which has already loaded bootstrap.php
 */

// If accessed directly (not via front controller), bootstrap ourselves
