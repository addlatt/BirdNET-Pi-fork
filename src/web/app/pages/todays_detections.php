...
if(isset($kiosk) && $kiosk == true) {
    echo "<div style='margin-top:20px' class=\"centered\"><h1><a><img class=\"topimage\" src=\"/assets/images/bnp.png\"></a></h1></div>
...
if(isset($_GET['ajax_detections']) && $_GET['ajax_detections'] == "true"  ) {
  ...
  ?>
        <?php if(isset($_GET['display_limit']) && is_numeric($_GET['display_limit'])){ ?>
          ...
          <a href="<?php echo $url;?>" target="_blank"><img style="cursor:pointer;float:unset;display:inline" title=<?php echo $url_title;?> src="/assets/images/info.png" width="20"></a>
          <a href="https://wikipedia.org/wiki/<?php echo $sciname;?>" target="_blank"><img style=";cursor:pointer;float:unset;display:inline" title="Wikipedia" src="/assets/images/wiki.png" width="20"></a>
          <img style=";cursor:pointer;float:unset;display:inline" title="View species stats" onclick="generateMiniGraph(this, '<?php echo $comnamegraph; ?>')" width=20 src="/assets/images/chart.svg"><br>
        ...
        <?php } else { //legacy mode ?>
          ...
          <?php echo $todaytable['Sci_Name'];?>
	                <br>
	                    <a href="<?php echo $url;?>" target="_blank"><img style="height: 1em;cursor:pointer;float:unset;display:inline" title=<?php echo $url_title;?> src="/assets/images/info.png" width="25"></a>
...
<div class="viewdb">
  ...
  <script src="/assets/js/chartjs-plugin-trendline.min.js"></script>
